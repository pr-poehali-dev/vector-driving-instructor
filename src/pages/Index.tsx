...
const BOT_FEATURES = [
  ...
  },
  {
    icon: "Clock",
    title: "Доступен 24/7",
    text: "Виртуальный помощник доступен для вас в любое время суток ",
  },
  {
    icon: "BookOpen",
...
const WHY_VECTOR = [
  {
    ...
    text: "Мастера Вектор Курган собрали самые частые вопросы учеников — и загрузили ответы прямо в бот. Никакой теории ради теории.",
  },
  {
    num: "02",
