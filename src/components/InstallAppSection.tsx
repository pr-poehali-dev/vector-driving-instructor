      ...
      <div className="relative max-w-6xl mx-auto px-6 py-20 md:py-28">
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 text-base max-w-xl mx-auto leading-relaxed">
            Добавьте иконку чата на главный экран телефона — и инструктор
            будет открываться в один клик, прямо как обычное приложение.
            Отвечает на вопросы по ПДД, парковке и манёврам в любое время дня
            и ночи.
          </p>
        </div>
